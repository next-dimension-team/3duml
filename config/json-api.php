...
return [
    ...
    */
    'schemas' => [
        'defaults' => [
            App\Models\CombinedFragment::class => '',
            App\Models\ExecutionSpecification::class => '',
            App\Models\InteractionFragment::class => '',
            App\Models\InteractionOperand::class => '',
            App\Models\Interaction::class => '',
            App\Models\Layer::class => '',
            App\Models\Lifeline::class => '',
            App\Models\Message::class => '',
            App\Models\OccurrenceSpecification::class => '',
        ],
        'v1' => [],
    ],
