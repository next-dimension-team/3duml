...
return [
    ...
    */
    'schemas' => [
        'defaults' => [
            App\Models\CombinedFragment::class => App\JsonApi\CombinedFragments\Schema::class,
            App\Models\ExecutionSpecification::class => App\JsonApi\ExecutionSpecifications\Schema::class,
            App\Models\InteractionFragment::class => App\JsonApi\InteractionFragments\Schema::class,
            App\Models\InteractionOperand::class => App\JsonApi\InteractionOperands\Schema::class,
            App\Models\Interaction::class => App\JsonApi\Interactions\Schema::class,
            App\Models\Layer::class => App\JsonApi\Layers\Schema::class,
            App\Models\Lifeline::class => App\JsonApi\Lifelines\Schema::class,
            App\Models\Message::class => App\JsonApi\Messages\Schema::class,
            App\Models\OccurrenceSpecification::class => App\JsonApi\OccurrenceSpecifications\Schema::class,
        ],
        'v1' => [],
    ],
    ...
    */
    'eloquent-adapter' => [
        'map' => [
            'combined-fragments' => App\Models\CombinedFragment::class,
            'execution-specifications' => App\Models\ExecutionSpecification::class,
            'interaction-fragments' => App\Models\InteractionFragment::class,
            'interaction-operands' => App\Models\InteractionOperand::class,
            'interactions' => App\Models\Interaction::class,
            'layers' => App\Models\Layer::class,
            'lifelines' => App\Models\Lifeline::class,
            'messages' => App\Models\Message::class,
            'occurrence-specifications' => App\Models\OccurrenceSpecification::class,
        ],
        'columns' => [],
    ],
